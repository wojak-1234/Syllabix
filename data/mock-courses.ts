...
export const MOCK_KNOWLEDGE_BASE: Course[] = [
  {
    ...
    instructorImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Max",
    rating: 4.8,
    difficulty: "beginner",
  ...
  },
  {
    ...
    provider: "도서",
    instructor: "이웅모",
    instructorImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Lee",
    rating: 4.9,
  ...
  },
  {
    ...
    provider: "인프런",
    instructor: "Unity Master",
    instructorImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Unity",
    rating: 4.7,
    difficulty: "beginner",
  ...
  },
  {
    ...
    provider: "코드트리",
    instructor: "알고리즘 최고수",
    instructorImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Algo",
    rating: 4.8,
    difficulty: "intermediate",
  ...
  },
  {
    ...
    provider: "김영한",
    instructor: "김영한 강사",
    instructorImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=Choi",
    rating: 5.0,
    difficulty: "intermediate",
  ...
  },
  {
    ...
    provider: "오픈튜토리얼스",
    instructor: "만능 AI 개발자",
    instructorImage: "https://api.dicebear.com/7.x/avataaars/svg?seed=AI",
    rating: 4.9,
    difficulty: "advanced",
